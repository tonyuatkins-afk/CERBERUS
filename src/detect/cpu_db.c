...
const cpu_db_entry_t cpu_db[] = {
    ...
    { CPU_DB_MATCH_CPUID, "GenuineIntel", 4, 3, 0, 15, "", "Intel i486DX2", 4700000UL, 10500000UL, "clock-doubled i486DX; range seeded from 486DX2-66 bench box" },
    ...
    { CPU_DB_MATCH_CPUID, "GenuineIntel", 4, 7, 0, 15, "", "Intel i486DX2 Write-Back Enhanced", 4700000UL, 10500000UL, "" },
    ...
    { CPU_DB_MATCH_CPUID, "AuthenticAMD", 4, 3, 0, 15, "", "AMD Am486DX2", 4700000UL, 10500000UL, "" },
    { CPU_DB_MATCH_CPUID, "AuthenticAMD", 4, 7, 0, 15, "", "AMD Am486DX2 Write-Back", 4700000UL, 10500000UL, "" },
