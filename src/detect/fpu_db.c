 ...
 * Source: hw_db/fpus.csv (14 entries)
 */
...
const fpu_db_entry_t fpu_db[] = {
    ...
    { "387-compat", "387-compatible coprocessor", "various", "IIT 3C87 / ULSI 83C387 / Cyrix FasMath 387+" },
...
const unsigned int fpu_db_count = 14;
